...
public class FormPacienteDieta extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(jtFechaIni, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(151, 151, 151)
                                .addComponent(jtFechaFin, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jSTabla, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(135, 135, 135)
    ...
    private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
        try{
            if(dietaActual==null){
                dietaActual=new Dietas(nroPaciente, nombreD, fechaIni, fechaFin, cantMenu, kcalSelec);
    ...
    private void jCKcalSItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jCKcalSItemStateChanged
        kcalSelec= jCKcalS.getSelectedItem().toString();
        seleccionKcal();
        cargarDatos();  
    ...
    private void jdFechaFinPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jdFechaFinPropertyChange
        ...
        for(int c=1;c<8;c++){
            switch(c){ 
                ...
                case 2:
                    if(cantMenu!=3){
                        modelo.addRow(new Object[]{"Martes",dietServ.kcalSemanal(kcalCol,2)}); 
                    }
                    break;
                case 3:
                    if(cantMenu!=4){
                        modelo.addRow(new Object[]{"Miercoles",dietServ.kcalSemanal(kcalCol,3)});
                    } 
                    break;
                case 4:
                    if(cantMenu!=3){
                        modelo.addRow(new Object[]{"Jueves",dietServ.kcalSemanal(kcalCol,4)});
                    } 
                    break;
                case 5:
                    modelo.addRow(new Object[]{"Viernes",dietServ.kcalSemanal(kcalCol,5)}); 
                    break;
                case 6:
                    if(cantMenu==6){
                        modelo.addRow(new Object[]{"Sábado",dietServ.kcalSemanal(kcalCol,6)});
                    } 
                    break;
                case 7:
                    if(cantMenu==6||cantMenu==7){
                        modelo.addRow(new Object[]{"Domingo",dietServ.kcalSemanal(kcalCol,7)});
                    } 
                    break;
                default:
                    break;
