...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-12-2024 a las 00:54:25
...
(602, '2 Huevos revueltos', 'Desayuno', 155, 'huevo', 1),
...
(606, 'Te Verde c/pan integral c/semillas', 'Desayuno', 242, 'panificado - te', 1),
...
(609, 'Capuchino c/pan y queso', 'Desayuno', 271, 'café - leche - panificado - queso', 1),
...
--
ALTER TABLE `renglondemenu`
  MODIFY `nroRenglon` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27426;
